...
- Optional download folders you pick stay on this computer via the File System
  Access API.
- Feedback is sent only if you submit it. The note is emailed to the maintainer.
  No email address is collected from you, and none is shown in Settings.
- There are no accounts, analytics pixels, or ad networks.

The public studio at [longshot-seven.vercel.app](https://longshot-seven.vercel.app)
is a preview of the editor. It does not capture other websites; that is what
