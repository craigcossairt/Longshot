...
- Capturing the Longshot editor itself: Chrome blocks content scripts on `chrome-extension://` pages. Visible capture of the editor works again.
- Full-page capture of the editor now tiles the scrolling canvas and keeps the toolbar strip above it.
